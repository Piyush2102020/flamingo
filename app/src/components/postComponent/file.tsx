        ...
        <div data-id={item._id} style={{padding:"var(--padding-medium)"}} className="post-component">
            ...
            <div className="post-footer">
                    ...
                    <Holder direction="horizontal">
                        <SmallIcon
                            onClick={handleClick}
                            icon={<svg xmlns="http://www.w3.org/2000/svg" fill={isLiked ? "var(--flamingo)" : "none"} viewBox="0 0 24 24" strokeWidth="1.5" stroke={isLiked ? "none" : "currentColor"} className="icon">
                        ...
                        <SmallIcon
                            icon={<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 256 256" fill="none" stroke="currentColor" strokeWidth="16px" strokeLinecap="round" strokeLinejoin="round">
                ...
                <Holder direction="horizontal">
                    <ClickableBoldText onClick={() => navigate(`/dashboard/profile?user=${item.userData.username}-${item.userData._id}`)} text={item.userData.username} />{item.content}
                </Holder>
